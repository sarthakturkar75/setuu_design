...
| **Employee** | Field workers | All projects via RLS | Create updates, upload media |
| **Vendor** | Suppliers / Subcontractors | Assigned projects / Org materials | Update assigned materials, scoped progress updates |
...
└── features/                          # Feature modules
    ...
    └── vendor/                        # Vendor-specific materials & assignments
```
