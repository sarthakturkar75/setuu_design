# Setuu Prototype — Exhaustive Implementation Plan
...
- [ ] **`/admin/security/dropzone` — ClamAV Upload Dropzone States**:
  - Visual reference page showing all 4 states of the dropzone:
    1. Idle: Dashed border, "Drag files here" prompt
    2. Scanning: Radar animation, "Scanning for threats..." text
    3. Clean: Emerald check, "File verified - Secure"
    4. Infected: Crimson shield, blurred file preview, "Remove Payload" button
...
| **New UI components to build** | 35+ |
| **Existing components to enhance** | 8 |
| **Server actions to create** | 60+ functions |
| **New page routes to build** | ~150 |
| **Sidebar navigations to rebuild** | 6 |
| **Topbar configurations to update** | 6 |
