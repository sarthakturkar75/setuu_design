...
export function Sidebar({
	...
	return (
		<aside
			className={cn(
				"w-sidebar md:w-rail lg:w-sidebar group/sidebar bg-primary-container shrink-0 flex flex-col h-full border-r border-outline-variant/10 shadow-elevation-l2 z-40 transition-all duration-normal overflow-x-hidden",
				className
			)}
			{...props}
		>
