  ...
  return (
    <div className="p-8 max-w-7xl mx-auto w-full">
      <div className="bg-surface-container-lowest p-12 rounded-2xl border border-outline-variant/30 shadow-sm text-center">
        ...
        <h1 className="font-merriweather text-3xl font-bold text-primary mb-4">Inventory</h1>
        <p className="text-on-surface-variant font-inter max-w-md mx-auto">
          This is a placeholder for the admin inventory module. Development is scheduled for an upcoming phase.
        </p>
      </div>
    </div>
  );
