...
import { Search, Filter, Edit2, Users, Tags } from 'lucide-react';
import { ManageTagsModal } from "@/components/ui/ManageTagsModal";
  ...
  return (
    <div className="flex flex-col h-full bg-surface pb-12">
      ...
      <div className="max-w-[1400px] mx-auto w-full p-6 mt-4">
        ...
        <div className="p-6 border border-outline-variant/30 bg-surface-variant/20 rounded-xl mb-8 shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <button 
            ...
            className="px-6 py-3 bg-surface text-on-surface border border-outline-variant rounded-lg text-sm font-semibold hover:bg-surface-variant shadow-sm transition-colors flex items-center gap-2 whitespace-nowrap"
          >
            <Tags className="w-4 h-4 text-primary" /> Manage Tags
          </button>
        </div>
