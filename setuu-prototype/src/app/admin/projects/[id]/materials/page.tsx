    ...
    <div className="p-6 max-w-[1600px] mx-auto space-y-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex items-center gap-3">
          <Link href={`/admin/projects/${id}/materials/receipt`} className="flex items-center gap-2 px-4 py-2 bg-surface-variant text-on-surface hover:bg-surface-variant/80 rounded-lg text-sm font-medium transition-colors">
