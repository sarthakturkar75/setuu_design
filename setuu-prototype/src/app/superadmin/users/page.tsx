...
import { getUsers, forceLogout } from "@/app/actions/userActions";
        ...
        <div className="flex gap-2">
          {row.is_active && (
            <button 
              ...
              className="px-3 py-1 bg-semantic-amber/10 text-semantic-amber hover:bg-semantic-amber hover:text-white rounded text-xs transition-colors border border-semantic-amber/30"
            >
              Force Logout
            </button>
          )}
  ...
  return (
    <div className="flex flex-col h-full bg-surface">
      <PageHeader 
        ...
        subtitle="Manage global platform access, roles, and emergency actions"
        breadcrumb={
