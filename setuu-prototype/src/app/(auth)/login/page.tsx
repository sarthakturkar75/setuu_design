    ...
    <div className="min-h-screen bg-surface dark:bg-surface-dark flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-surface-container-lowest dark:bg-surface-container-lowest-dark border border-outline-variant dark:border-outline-variant-dark rounded-xl shadow-sm p-8">
        <div className="text-center mb-8">
          <h1 className="font-merriweather text-3xl font-bold text-on-surface dark:text-on-surface-dark mb-2">Setuu Enterprise</h1>
          <p className="font-inter text-on-surface-variant dark:text-on-surface-variant-dark">Sign in to your account</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div className="flex justify-end mt-1">
            <a href="/forgot-password" className="text-primary text-sm hover:underline font-inter">Forgot Password?</a>
          </div>
          </div>
          <button 
            type="submit" 
        ...
        <div className="mt-6 text-center">
          <p className="font-inter text-sm text-on-surface-variant dark:text-on-surface-variant-dark">
            Don&apos;t have an account? <a href="/signup" className="text-secondary dark:text-secondary-dark font-semibold hover:underline">Request Access</a>
          </p>
        </div>
      </div>
    </div>
