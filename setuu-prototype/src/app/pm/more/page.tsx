...
import { ShieldCheckIcon, BookOpenIcon, FileTextIcon, CircleHelpIcon, SettingsIcon, LogOutIcon } from "lucide-react";
...
export default function PMMoreMenu() {
  const links = [
    ...
    { label: "Support Tickets", href: "/pm/support", icon: CircleHelpIcon },
  ];
