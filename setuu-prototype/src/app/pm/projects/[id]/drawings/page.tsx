...
export default function DrawingAnnotationPage() {
  ...
  const columns = [
    ...
    { key: "actions", header: "", cell: (row: any) => <a href={row.file_url} target="_blank" rel="noreferrer" className="text-primary hover:underline flex items-center gap-1 text-sm"><EyeIcon className="w-4 h-4"/> View</a> }
  ];
