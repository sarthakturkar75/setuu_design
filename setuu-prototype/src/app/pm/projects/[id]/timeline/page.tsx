    ...
    <div className="p-6 max-w-300 mx-auto space-y-8">
      ...
      <div className="relative pl-8 border-l-2 border-outline-variant/30 space-y-8">
        ...
        <div className="relative">
          <div className="absolute -left-10.25 top-0 p-1.5 bg-semantic-emerald-bg rounded-full border-4 border-surface">
        ...
        <div className="relative">
          <div className="absolute -left-10.25 top-0 p-1.5 bg-primary/10 rounded-full border-4 border-surface">
        ...
        <div className="relative">
          <div className="absolute -left-10.25 top-0 p-1.5 bg-semantic-amber-bg rounded-full border-4 border-surface">
