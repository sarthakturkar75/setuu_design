      ...
      <PageHeader 
        ...
        actions={
          <div className="flex gap-3">
            <Button variant="outline"><PlusIcon className="w-4 h-4 mr-2" /> New Meeting</Button>
            <Button variant="primary"><FileCheckIcon className="w-4 h-4 mr-2" /> New Handover</Button>
          </div>
        }
      />
